...
<%
    ...
    List<User> adminListSearch = userDao.searchAdminByName(dataSearch);
%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <main class="main">
            ...
            <%} else {
            if(!adminListSearch.isEmpty()) {
            userList = adminListSearch;
            } 
            %>
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="table__data"><%=u.getDeliveryAddress()%></p>
                        </td>
                        ...
                        <td>
                            <div class="table__act">
                                <a href="admin-update.jsp?id=<%=u.getId()%>" class="table__act-btn table__act-btn-edit" title="edit">
                                    <svg
                                        fill="rgb(143, 159, 188)"
                                        xmlns="http://www.w3.org/2000/svg"
                                        height="1em"
                                ...
                                <a href="admin-avatar.jsp?id=<%=u.getId()%>" class="table__act-btn table__act-btn-avatar"  title="avatar">
                                ...
                                <%if(u.getStatus() == 0) {%>
                                <a href="delete-admin?id=<%=u.getId()%>" class="table__act-btn table__act-btn-remove"  title="remove">
                                    <svg
                                        fill="#fff"
                                        xmlns="http://www.w3.org/2000/svg"
                                        height="1em"
