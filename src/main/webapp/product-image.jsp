...
<%
    ...
    request.setAttribute("id", currentProduct.getpId());
%>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <main class="auth main">
            ...
            <div id="auth-content" class="auth__content">
                <div class="auth__content-inner admin-content-inner">
                    <h1 class="auth__heading">Update your image</h1>
                    <p class="auth__desc">Choose your image file less than 5MB</p>
                    <p class="form__error">${error == "" ? "" : error}</p>
                    <p class="form__note">${note == "" ? "" : note}</p>
                    <form action="product-img" enctype="multipart/form-data" method="POST" class="form auth__form" id="sign-up-form">


			<input type="hidden" name="id" value="<%=currentProduct.getpId() %>"/>
                        <div class="form__group admin-upload-image">
                            <label for="avatar" class="form__label">Update Image Product</label>
                            ...
                            <label for="avatar">
                                <%
                                    ...
                                    String avatarURL= currentProduct.getpThumb();
                                    if (avatarURL != null) {
