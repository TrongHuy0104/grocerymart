                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table__act">
                                ...
                                <a href="customer-avatar.jsp?id=<%=u.getId()%>" class="table__act-btn table__act-btn-avatar"  title="avatar">
                                ...
                                <a href="delete-user?id=<%=u.getId()%>" class="table__act-btn table__act-btn-remove"  title="remove">
                                    <svg
                                        fill="#fff"
                                        xmlns="http://www.w3.org/2000/svg"
                                        height="1em"
