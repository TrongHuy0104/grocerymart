 ...
 * @author Trong Huy
 */
public class PagingSearchControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int pageLimit = 16;
        // Get Total Products
        int pCount = dao.countTotalByName(dataSearch);
        ...
        List<Product> productList = dao.searchByName(dataSearch, index);
